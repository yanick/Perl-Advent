...
pressure and chronically undermanned (in this case, quite litterally,
...
develfopers lead by Gluggagægir make sure that the bedlam remains under
relative control.
...
to be able to leverage L<App::jt> to tame and manipulate the document,
